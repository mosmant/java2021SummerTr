package day24_List_ForEachLoops;
...
public class C01_List01 {
	...
	public static void main(String[] args) {
		 ...
		 */
			// array yapsam kaç adet isim gireceðimiz belli deðil.
			// hoca do while loop ile yapmayý önerdi.
			// scanner objesini loopun içinde oluþturursak hafýzayý sürekli meþgul eder.
			// o yüzden scanner objesini loopun dýþýnda yapmalýyýz. looptan önce...
		
		Scanner scan=new Scanner(System.in);
		List<String> girilenIsimler=new ArrayList<>(); // kullanýcýdan gelecek olan isim list i
		String isim;  
