...
public class C3_LinkedList03 {
	...
	public static void main(String[] args) {
		...
		ll1.addFirst("B"); 
		System.out.println(ll1); // [B, A, B]
		System.out.println(ll1.removeFirstOccurrence("C")); // true veya false dondurur ==> false çünkü elementler de yok
		System.out.println(ll1);// [B, A, B] burada elemanlardan birisini silmedik
